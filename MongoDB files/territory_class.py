...
class Territory: # the territory class.
    def __init__(self, id_num, name, pos, blob_names, real_blobs, borders, bonus_group, controller, force_no, dots, numer_point,screen): #(8) the attributes of the "territory" class.
    ...
    def stick_force_no(self): # method for appliying the force-number onto the applied blob.
        font1 = pygame.font.Font('freesansbold.ttf', 25) # initialize the font.
        text = font1.render(str(self.force_no), True, (0,0,1)) # initialize the text. ######
