...
blob_suffix = str(" - outline.png")
for cnt1 in range(0, 82, 1):
    print(str(entire_string[cnt1]) + '_outline_links = {"_id":' + str(cnt1) + ',"name":"' + str(str(entire_string[cnt1])) + '","strings": [', end="")
...
for cnt1 in range(0, 82, 1):
    print("collection.insert_one(" + str(entire_string[cnt1]) + "_outline_links)")