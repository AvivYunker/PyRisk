...
class Button: # define the "Button" class.
    def __init__ (self, font, text, color, dimen, thick, value, img, screen): #(8) the attributes of the "territory" class.
        ...
        self.put_img() # methof for putting the image of the button-object.
    ...
    def button_functional(self, val): # method for functionalizing the button.
        self.button_on_hover() # method for determining if the mouse is hovering over the button.
    ...
    def button_on_hover(self): # method for determining if the mouse is hovering over the button.
        ...
        if (self.dimen[0]+self.dimen[2] > mouse[0] > self.dimen[0] and self.dimen[1]+self.dimen[3] > mouse[1] > self.dimen[1]): # if the mouse is within the rectangle of the button.
