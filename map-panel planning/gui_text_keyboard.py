...
# KEYBOARD
gt0 = gui_text("ATTACK", 40, 0, [560,425,1,40], screen) # level 1
gt2 = gui_text("012345, select fortifying territory!", 20, 0, [483,470,1,20], screen) # level 2
gt1 = gui_text("012345, select attacking territory!", 20, 0, [15,500,1,20], screen) # level 3
gt5 = gui_text("15 remaining", 20, 0, [575,500,1,20], screen) # level 4
gt3 = gui_text("012345, select territory to attack!", 20, 0, [960,500,1,20], screen) # level 5
gt4 = gui_text("ATTACKER: Alaska", 20, 0, [15,535,1,20], screen) # level 6
one_valued_dice(580,535,(34,139,34)) # level 7
one_valued_dice(670,535,(34,139,34)) # level 8
gt6 = gui_text("ATTACKED: Alberta", 20, 0, [960,535,1,20], screen) # level 9
...
# keyboard
skip_attack_button = Button(1, "SKIP", back_mode, (1153,565,140,50), 5, 6, 0, screen) # initiate the "skip" button.
auto_attack_button = Button(1, "AUTO", back_mode, (430,565,140,50), 5, 6, 0, screen) # initiate the "auto" button.
skip_attack_button = Button(1, "SKIP", back_mode, (573,565,140,50), 5, 6, 0, screen) # initiate the "skip" button.
manual_attack_button = Button(1, "MANUAL", back_mode, (715,565,140,50), 5, 6, 0, screen) # initiate the "auto" button.
save_button = Button(1, "SAVE", back_mode, (1153,429,140,50), 5, 6, 0, screen) # initiate the "skip" button.
