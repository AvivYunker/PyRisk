...
screen.blit(game_map,(100,0))
#screen.fill((255,255,255))

pygame.draw.lines(screen, (255,255,255), False, [(0,720),(1227,720)], 3)
...
# SQUARES
gt0 = gui_text("ATTACK", 40, 0, [430,725,1,40], screen) # level 1
gt1 = gui_text("012345, select fortifying territory!", 20, 0, [338,767,1,20], screen) # level 2
gt2 = gui_text("012345, select attacking territory!", 20, 0, [15,797,1,20], screen) # level 3
gt3 = gui_text("15 remaining", 20, 0, [450,797,1,20], screen) # level 4
gt4 = gui_text("012345, select territory to attack!", 20, 0, [660,797,1,20], screen) # level 5
gt5 = gui_text("ATTACKER: Alaska", 20, 0, [15,827,1,20], screen) # level 6
one_valued_dice(455,827,(34,139,34)) # level 7
one_valued_dice(545,827,(34,139,34)) # level 8
gt6 = gui_text("ATTACKED: Alberta", 20, 0, [660,827,1,20], screen) # level 9
...
# squares
#auto_attack_button = Button(1, "MANUAL", back_mode, (305,865,140,50), 5, 6, 0, screen) # initiate the "auto" button.
#skip_move_button = Button(1, "SKIP", back_mode, (448,865,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#manual_attack_button = Button(1, "AUTO", back_mode, (590,865,140,50), 5, 6, 0, screen) # initiate the "auto" button.
#skipMove_autoFortify_button = Button(1, "SKIP", back_mode, (853,865,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#save_button = Button(1, "SAVE", back_mode, (853,729,140,50), 5, 6, 0, screen) # initiate the "skip" button.

while (True):
    for event in pygame.event.get():
        y = screen.get_size()[1]
        #print("The width is: " + str(x))
        print("The height is: " + str(y))
