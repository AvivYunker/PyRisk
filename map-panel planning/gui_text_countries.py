...
screen = pygame.display.set_mode((1227,828))
...
# COUNTRIES
gt0 = gui_text("ATTACK", 40, 0, [535,635,1,40], screen) # level 1
gt1 = gui_text("012345, select fortifying territory!", 20, 0, [450,680,1,20], screen) # level 2
gt2 = gui_text("012345, select attacking territory!", 20, 0, [50,710,1,20], screen) # level 3
gt5 = gui_text("15 remaining", 20, 0, [545,710,1,20], screen) # level 4
gt3 = gui_text("012345, select territory to attack!", 20, 0, [850,710,1,20], screen) # level 5
gt4 = gui_text("ATTACKER: Alaska", 20, 0, [50,740,1,20], screen) # level 6
one_valued_dice(550,740,(34,139,34)) # level 7
one_valued_dice(640,740,(34,139,34)) # level 8
gt6 = gui_text("ATTACKED: Alberta", 20, 0, [850,740,1,20], screen) # level 9
...
# countries
#auto_attack_button = Button(1, "AUTO", back_mode, (400,773,140,50), 5, 6, 0, screen) # initiate the "manual" button.
#skip_move_button = Button(1, "SKIP", back_mode, (543,773,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#manual_attack_button = Button(1, "MANUAL", back_mode, (685,773,140,50), 5, 6, 0, screen) # initiate the "auto" button.
#skipMove_autoFortify_button = Button(1, "SKIP", back_mode, (1080,773,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#save_button = Button(1, "SAVE", back_mode, (1080,637,140,50), 5, 6, 0, screen) # initiate the "skip" button.
