...
#pygame.draw.lines(screen, (255,255,255), False, [(0,628),(1227,628)], 3)

# screen.fill((255,255,255))

# WHAT TEXT DO WE NEED?
# FORTIFY # 7
# 012345, click on territories to fortify! # 20
...
class gui_text:
    ...
    def remove_gui_text (self):
        ...
        pygame.display.update()
        pygame.draw.rect(screen, (255,255,255), (self.dimen[0],self.dimen[1],self.dimen[2]*self.size*length_remove*0.6+15,self.dimen[3]))
        # self.default_color
        pygame.display.update()

# HEXAGONS
gt0 = gui_text("ATTACK", 40, 0, [508,512,1,40], screen) # level 1
gt1 = gui_text("012345, select fortifying territory!", 20, 0, [434,557,1,20], screen) # level 2
gt2 = gui_text("012345, select attacking territory!", 20, 0, [50,587,1,20], screen) # level 3
gt3 = gui_text("15 remaining", 20, 0, [520,587,1,20], screen) # level 4
gt4 = gui_text("012345, select territory to attack!", 20, 0, [825,587,1,20], screen) # level 5
gt5 = gui_text("ATTACKER: Alaska", 20, 0, [50,617,1,20], screen) # level 6
one_valued_dice(525,617,(34,139,34)) # level 7
one_valued_dice(615,617,(34,139,34)) # level 8
gt6 = gui_text("ATTACKED: Alberta", 20, 0, [825,617,1,20], screen) # level 9
...
# hexagons
#auto_attack_button = Button(1, "AUTO", back_mode, (375,645,140,50), 5, 6, 0, screen) # initiate the "auto" button.
#skip_move_button = Button(1, "SKIP", back_mode, (518,645,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#manual_attack_button = Button(1, "AUTO", back_mode, (660,645,140,50), 5, 6, 0, screen) # initiate the "auto" button.
#skipMove_autoFortify_button = Button(1, "SKIP", back_mode, (1053,645,140,50), 5, 6, 0, screen) # initiate the "skip" button.
#save_button = Button(1, "SAVE", back_mode, (1053,509,140,50), 5, 6, 0, screen) # initiate the "skip" button.
