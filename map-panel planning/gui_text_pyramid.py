...
# PYRAMID
gt0 = gui_text("ATTACK", 40, 0, [430,602,1,40], screen) # level 1
gt2 = gui_text("012345, select fortifying territory!", 20, 0, [338,647,1,20], screen) # level 2
gt1 = gui_text("012345, select attacking territory!", 20, 0, [5,677,1,20], screen) # level 3
gt5 = gui_text("15 remaining", 20, 0, [445,677,1,20], screen) # level 4
gt3 = gui_text("012345, select territory to attack!", 20, 0, [660,677,1,20], screen) # level 5
gt4 = gui_text("ATTACKER: Alaska", 20, 0, [5,707,1,20], screen) # level 6
one_valued_dice(450,707,(34,139,34)) # level 7
one_valued_dice(540,707,(34,139,34)) # level 8
gt6 = gui_text("ATTACKED: Alberta", 20, 0, [660,707,1,20], screen) # level 9
...
# pyramid
auto_attack_button = Button(1, "AUTO", back_mode, (300,745,140,50), 5, 6, 0, screen) # initiate the "auto" button.
skip_move_button = Button(1, "SKIP", back_mode, (443,745,140,50), 5, 6, 0, screen) # initiate the "skip" button.
manual_attack_button = Button(1, "MANUAL", back_mode, (585,745,140,50), 5, 6, 0, screen) # initiate the "auto" button.
skipMove_autoFortify_button = Button(1, "SKIP", back_mode, (853,745,140,50), 5, 6, 0, screen) # initiate the "skip" button.
save_button = Button(1, "SAVE", back_mode, (853,609,140,50), 5, 6, 0, screen) # initiate the "skip" button.
